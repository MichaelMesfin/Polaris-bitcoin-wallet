...
import polaris.wallettemplate.walletfx.utils.QRCodeImages;
...
public class ClickableBitcoinAddress extends AnchorPane implements OverlayController<ClickableBitcoinAddress> {
  ...
  protected Label qrCode;
    ...
    public ClickableBitcoinAddress() throws IOException {
        GridPane controlBox = new GridPane();
        this.addressLabel = new Label();
        this.copyWidget = new Label();
        this.qrCode = new Label();
        controlBox.add(this.addressLabel, 0, 0,2,1);
        controlBox.add(this.copyWidget, 0, 1);
        controlBox.add(this.qrCode, 1, 1);
        controlBox.setVgap(10);
        controlBox.setHgap(20);
        
        super.getChildren().add(controlBox);
        
//            /home/michael/Documents/wallet/my-wallet/src/main/resources/roundtrip/bitcoinj/walletfx/controls/bitcoin_address.fxml
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/walletfx/controls/bitcoin_address.fxml"));
            loader.setRoot(this);
...
//            loader.load();
        ...
        qrCode.setOnMousePressed(eh -> showQRCode(eh));
        this.copyWidget.setOnMousePressed(this::copyAddress);
    ...
    @FXML
    protected void copyAddress(MouseEvent event) {
    ...
    @FXML
    protected void copyWidgetClicked(ActionEvent event) {
        copyAddress(null);
    }
