 ...
 */
package polaris.wallettemplate.walletfx.overlay;
...
import static polaris.wallettemplate.walletfx.utils.GuiUtils.blurIn;
import static polaris.wallettemplate.walletfx.utils.GuiUtils.blurOut;
import static polaris.wallettemplate.walletfx.utils.GuiUtils.checkGuiThread;
import static polaris.wallettemplate.walletfx.utils.GuiUtils.explodeOut;
import static polaris.wallettemplate.walletfx.utils.GuiUtils.fadeIn;
import static polaris.wallettemplate.walletfx.utils.GuiUtils.fadeOutAndRemove;
import static polaris.wallettemplate.walletfx.utils.GuiUtils.zoomIn;
import static polaris.wallettemplate.walletfx.utils.GuiUtils.zoomFit;
...
public abstract class OverlayableStackPaneController {
     ...
     * w
     * 
     * ill be the root node of a {@code Scene} contained in a {@code Stage}.
     */
    ...
    public <T extends OverlayController<T>> OverlayUI<T> overlayUI(Node node, T controller) {
        ...
        //here the controller sets observable properties
